public class TestProfile {
    public static void main(String[] args) {
        ...
        ProfileDTO dto1 = new ProfileDTO(
            "1", "1", "1", "1", "권은비", 60, "FEMALE", "ESTJ", 163, 65, "1"
        );
        ...
        ProfileDTO dto2 = new ProfileDTO(
            "2", "2", "2", "2", "차은우", 70, "MALE", "ESFJ", 180, 80, "3"
        );
        ...
        ProfileDTO dto3 = new ProfileDTO(
            "3", "3", "3", "3", "권지언", 75, "MALE", "ENTP", 195, 80, "5"
        );
        ...
        ProfileDTO dto4 = new ProfileDTO(
            "4", "4", "4", "4", "이민호", 85, "MALE", "ESFJ", 188, 90, "4"
        );
        ...
        ProfileDTO dto5 = new ProfileDTO(
            "5", "5", "5", "5", "문종근", 65, "MALE", "ESTJ", 180, 80, "7"
        );
